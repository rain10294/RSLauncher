...
exports.USE_CMLLIB_DEFAULT_CLIENT = launcherConfig.microsoftAuthMode === 'cmllib-default'
...
exports.MSFT_OPCODE = {
    ...
    CML_REFRESH: 'MSFT_AUTH_CML_REFRESH',
...
exports.MSFT_ERROR = {
    ...
    AUTH_FAILED: 'MSFT_AUTH_ERR_AUTH_FAILED'
}
